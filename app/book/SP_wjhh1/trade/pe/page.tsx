  ...
  return (
    <div className="space-y-6 pb-10 max-w-[1400px] mx-auto">
      <div className="border-b border-gray-200 pb-4 flex justify-between items-end">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">私募基金交易录入 (PE Trade)</h1>
          <p className="mt-1 text-sm text-gray-500">
            录入私募基金产品的申购、赎回等交易流水，系统将自动计算含费金额与均价。
          </p>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            ...
            <div className="col-span-1">
              ...
              <select name="direction" value={formData.direction} onChange={handleInputChange} className={`w-full p-2 border rounded text-sm font-bold outline-none ${formData.direction === 'BUY' ? 'text-red-600 bg-red-50' : 'text-green-600 bg-green-50'}`}>
                <option value="BUY">申购 (BUY)</option>
                <option value="SELL">赎回 (SELL)</option>
              </select>
            </div>

            {/* 第二行：基金信息与数值 */}
            <div className="col-span-1">
              <label className="block text-xs font-medium text-gray-500 mb-1">基金简码</label>
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <input type="text" name="fundName" placeholder="输入基金全称" required value={formData.fundName} onChange={handleInputChange} className="w-full p-2 border rounded text-sm outline-none focus:ring-2 focus:ring-purple-500" />
            </div>
            <div className="col-span-1">
          ...
          <table className="w-full text-sm text-left">
            <thead className="bg-gray-50 text-gray-500 font-medium border-b border-gray-200">
              <tr>
                ...
                <th className="px-4 py-3 text-right whitespace-nowrap">份额数量</th>
