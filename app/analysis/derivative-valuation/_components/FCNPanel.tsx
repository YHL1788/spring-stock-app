            ...
            <div className="lg:col-span-1 bg-white shadow rounded-lg p-5 max-h-[1200px] overflow-y-auto space-y-6">
                ...
                <div>
                    ...
                    <div className="grid grid-cols-2 gap-3 text-xs">
                        ...
                        <div>
                            ...
                            <input type="text" name="executor" value={basicParams.executor} onChange={handleBasicChange} placeholder={EXAMPLE_PARAMS.executor} className="w-full border-gray-300 rounded shadow-sm border p-1.5" />
                        </div>
                        <div>
                ...
                <div className="flex space-x-3">
                    <button
                        ...
                        disabled={loading}
                        className={`flex-1 py-3 px-4 rounded-md text-white font-medium transition-colors shadow-sm flex justify-center items-center ${loading ? 'bg-blue-400 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700'
                            }`}
                    >
            ...
            <div className="lg:col-span-1 bg-white shadow rounded-lg p-6 min-h-[600px]">
                {fcnResult ? (
                    ...
                    <div className="h-full flex flex-col items-center justify-center text-gray-400">
                        ...
                        <p className="text-sm mt-2">或点击 "示例运行" 查看效果</p>
                        <p className="text-xs mt-1 text-gray-300">基于 {Number(basicParams.n_sims) || 5000} 次蒙特卡洛模拟</p>
                    </div>
                )}
            </div>
        </div>
